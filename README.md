...
```
Strings are encrypted with a default 64 bit key. To increase security it is recommended to generate a random key at compile time and pass it into `AY_OBFUSCATE_KEY("Hello World", KEY)`.
